    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-100 px-6 py-24">
      <div className="text-center max-w-4xl">
        ...
        <p className="text-xl sm:text-2xl md:text-4xl text-gray-700 mb-8">
          AI generator of banners, Reels and visuals<br />for Shopify in 30 seconds
        </p>
        <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
          Connect your store → Choose style → Get 100+ ready assets instantly
        </p>
        ...
        <p className="mt-16 text-gray-500 text-sm">
          Music for stories → <a href="https://rifrush.com" className="underline hover:text-indigo-600">rifrush.com</a>
        </p>
      </div>
    </main>
  )
